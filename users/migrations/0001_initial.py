...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_accounts', (
            ...
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=500)),
            ('join_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal(u'users', ['Accounts'])


    def backwards(self, orm):
        # Deleting model 'Accounts'
        db.delete_table(u'users_accounts')
    ...
    models = {
        ...
        u'users.accounts': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
